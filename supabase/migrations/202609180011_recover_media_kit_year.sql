...
-- Recupera bases em que a migration de ano do media kit não foi aplicada.
-- É segura tanto para bancos já atualizados quanto para os que ainda não têm a coluna.
